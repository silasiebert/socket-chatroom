...
\begin{figure}[H]
\lstinputlisting[firstline=21,lastline=41,frame=single]{../../TrabalhoFinal/src/trabalhofinal/Cliente.java}
\caption{Loop que recebe mensagens do servidor}
\end{figure}


\begin{figure}[H]
\lstinputlisting[firstline=77,lastline=80,frame=single]{../../TrabalhoFinal/src/trabalhofinal/control/TelaClienteController.java}
\caption{Metodo para mostrar a mensagem na tela}
\end{figure}

\begin{figure}[H]
\lstinputlisting[firstline=58,lastline=75,frame=single]{../../TrabalhoFinal/src/trabalhofinal/control/TelaClienteController.java}
...
\begin{figure}[H]
\lstinputlisting[firstline=17,lastline=24,frame=single]{../../TrabalhoFinal/src/trabalhofinal/Servidor.java}
...
\begin{figure}[H]
	\lstinputlisting[firstline=33,lastline=36,frame=single]{../../TrabalhoFinal/src/trabalhofinal/SecCrit.java}
...
\begin{figure}[H]
\lstinputlisting[firstline=30,lastline=53,frame=single]{../../TrabalhoFinal/src/trabalhofinal/Ouvinte.java}
